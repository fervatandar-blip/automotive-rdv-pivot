...
import { COUNTRIES, COUNTRY_NAMES } from "@/lib/business-registration";
    ...
    return (
      <div className="flex flex-col items-center gap-4 rounded-xl border border-black/[.08] bg-white p-8 text-center dark:border-white/[.145] dark:bg-zinc-950">
        ...
        <p className="max-w-sm text-sm text-zinc-600 dark:text-zinc-400">
          A member of our team will reach out shortly. In the meantime, feel
          free to grab a time that works for you.
        </p>
        {bookingUrl ? (
          <a
            href={bookingUrl}
